							...
							<div class="card card-custom overflow-hidden position-relative mb-8">
									...
									<span class="svg-icon svg-icon-full flex-row-fluid p-15">
										<!--begin::Svg Icon | path:assets/media/svg/illustrations/working.svg--><svg
											...
											<rect x="372.13" y="350.43" width="91.92" height="5.2"
												transform="translate(-155.26 -13.18) rotate(-12.75)" fill="#6c63ff"
												opacity="0.3" />
											<rect x="373.89" y="354.04" width="166.5" height="5.2"
												transform="translate(-155.1 -4.47) rotate(-12.75)" fill="#6c63ff"
												opacity="0.3" />
											<rect x="376.57" y="365.88" width="166.5" height="5.2"
												transform="translate(-157.64 -3.59) rotate(-12.75)" fill="#6c63ff"
												opacity="0.3" />
											<rect x="379.4" y="379.06" width="154.36" height="5.2"
												transform="translate(-160.63 -3.98) rotate(-12.75)" fill="#6c63ff"
												opacity="0.3" />
											<rect x="381.93" y="389.56" width="166.5" height="5.2"
												transform="translate(-162.74 -1.82) rotate(-12.75)" fill="#6c63ff"
												opacity="0.3" />
											<rect x="385.59" y="410.21" width="86.72" height="5.2"
												transform="translate(-168.19 -9.31) rotate(-12.75)" fill="#6c63ff"
												opacity="0.3" />
											...
											<rect x="337.76" y="165.98" width="100.59" height="69.38"
												transform="translate(-122.37 -23.57) rotate(-12.75)" fill="#6c63ff"
												opacity="0.3" />
											<rect x="433.79" y="236.72" width="100.59" height="69.38"
												transform="translate(-135.62 -0.63) rotate(-12.75)" fill="#6c63ff"
												opacity="0.3" />
											...
											<rect x="909.58" y="347.82" width="44" height="38"
												transform="translate(43.2 -348.39) rotate(15.4)" fill="#3ad29f"
												opacity="0.3" />
								...
								<div class="position-relative px-20">
									<ul class="nav nav-tabs nav-tabs-line" role="tablist">
										...
										<!--begin::Nav Item-->
										<li class="nav-item mr-14 mt-4">
											<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0"
												data-toggle="tab" href="#kt_tabs_6_2">Video Tutorials</a>
										</li>
										<!--end::Nav Item-->
										...
										<li class="nav-item mr-14 mt-4">
											<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0"
												data-toggle="tab" href="#kt_tabs_6_3">License Terms</a>
										</li>
										<!--end::Nav Item-->
										...
										<li class="nav-item mr-14 mt-4">
											<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0"
												data-toggle="tab" href="#kt_tabs_6_4">Copyright</a>
										</li>
										<!--end::Nav Item-->
										...
										<li class="nav-item mr-14 mt-4">
											<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0"
												data-toggle="tab" href="#kt_tabs_6_5">Tax & Compliance</a>
										</li>
										<!--end::Nav Item-->
										...
										<li class="nav-item mt-4">
											<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0"
												data-toggle="tab" href="#kt_tabs_6_6">Support</a>
										</li>
										<!--end::Nav Item-->
									</ul>
								</div>
												...
												<div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle"
													...
													<div class="card">
														...
														<div class="card-header" id="headingThree7">
															<div class="card-title collapsed" data-toggle="collapse"
																data-target="#collapseThree7" aria-expanded="true"
																role="button">
																<span class="svg-icon svg-icon-primary">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-double-right.svg--><svg
																		xmlns="http://www.w3.org/2000/svg"
											...
											<div class="p-6">
												...
												<div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle"
													...
													<div class="card">
														...
														<!--begin::Body-->
														<div id="collapseTwo8" class="collapse"
										...
										<div class="card-body">
											<div class="p-4">
												<div class="d-flex justify-content-between align-items-center mb-8">
													...
													<!--begin::Badge-->
													<div
														class="btn btn-text btn-sm btn-light-primary font-weight-bolder">
														Blog</div>
													<!--end::Badge-->
												</div>
												<!--begin::Content-->
												<div class="text-dark-50 font-size-lg">
													<p>
														Windows 10 automatically downloads and installs updates to make
														sure your device is secure and up to date.
														This means you receive the latest fixes and security updates,
														helping your device run efficiently and stay protected.
														In most cases, restarting your device completes the update. Make
														sure your device is plugged in when you know updates will be
														installed.
													</p>
										...
										<div class="card-body">
											<div class="p-4">
												<div class="d-flex justify-content-between align-items-center mb-8">
													...
													<!--begin::Badge-->
													<div
														class="btn btn-text btn-sm btn-light-success font-weight-bolder">
														Blog</div>
													<!--end::Badge-->
												</div>
												<!--begin::Content-->
