...
if(isset($_GET['oid'])&&$neworder->check_order($_GET['oid'])){
$oid=$_GET['oid'];
...
require_once (dirname(__FILE__,3)).'/'.DIR_INC.'/API_Product.php';
require_once (dirname(__FILE__,3)).'/'.DIR_INC.'/API_Product_variant.php';
$newdb=new DB_init();
$apiorder=new API_Order();
$apipr=new API_Product();
$newpr=new SP_Product();
$apiprvariant=new API_Product_variant();
$to_address="No Shipping Address";
$get_store_prp=$newdb->get_shop_prp();
$get_s_order=$neworder->get_single_order($oid);
$order_ad=$apiorder->get_order_address($oid);
// init the variable of the product-order row 
if(!empty($order_ad)){

	$order_ad=$order_ad['address'];
	$to_address=$order_ad['name']." ".$order_ad['address1']." ".$order_ad['city']."<br>".$order_ad['province'].",".$order_ad['country'].",".$order_ad['country'].",".$order_ad['phone'];

}
$products=$newpr->get_product_order2($neworder->get_order_id($oid,$aid)['OID']);
												...
												<ul class="menu-subnav">
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/typography.html"
																		class="menu-link">
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/buttons.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/button-group.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/dropdown.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/navs.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/tables.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/progress.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/modal.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/alerts.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/popover.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/bootstrap/tooltip.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/utilities.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/accordions.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/label.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/pulse.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/line-tabs.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/advance-navs.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/timeline.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/pagination.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/symbol.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/spinners.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/iconbox.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/callout.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/custom/ribbons.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/icons/flaticon.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/icons/fontawesome5.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/icons/lineawesome.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/icons/socicons.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/icons/svg.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/icons/keenthemes-icons.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/cards/general.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/cards/stacked.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/cards/tabbed.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/cards/draggable.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/cards/tools.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/cards/sticky.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/cards/stretched.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/widgets/lists.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/widgets/stats.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/widgets/charts.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/widgets/mixed.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/widgets/feeds.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/widgets/engage.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/widgets/base-tables.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/widgets/advance-tables.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/widgets/nav-panels.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/calendar/basic.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/calendar/list-view.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/calendar/google.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/calendar/external-events.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/calendar/background-events.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/charts/apexcharts.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/features/charts/amcharts/charts.html"
																					class="menu-link">
																					<i
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/features/charts/amcharts/stock-charts.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/features/charts/amcharts/maps.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/charts/flotcharts.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/charts/google-charts.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/maps/google-maps.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/maps/leaflet.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/maps/jqvmap.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div class="menu-submenu menu-submenu-classic menu-submenu-right"
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/kanban-board.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/sticky-panels.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/blockui.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/perfect-scrollbar.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/treeview.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/bootstrap-notify.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/toastr.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/sweetalert2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/dual-listbox.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/session-timeout.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/idle-timer.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/features/miscellaneous/cropper.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
												...
												<ul class="menu-subnav">
															...
															<ul class="menu-subnav">
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/controls/base.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/controls/input-group.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/controls/checkbox.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/controls/radio.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/controls/switch.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/controls/option.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/bootstrap-datetimepicker.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/bootstrap-datepicker.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/bootstrap-timepicker.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/bootstrap-daterangepicker.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/tagify.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/bootstrap-touchspin.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/bootstrap-maxlength.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/bootstrap-switch.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/bootstrap-multipleselectsplitter.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/bootstrap-select.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/select2.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/typeahead.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/nouislider.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/form-repeater.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/ion-range-slider.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/input-mask.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/jquery-mask.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/autosize.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/clipboard.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/widgets/recaptcha.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/editors/tinymce.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item menu-item-submenu"
																				...
																				<div
																					...
																					<ul class="menu-subnav">
																						<li class="menu-item"
																							aria-haspopup="true">
																							<a href="/metronic/demo2/crud/forms/editors/ckeditor-classic.html"
																								class="menu-link">
																								<i
																						...
																						<li class="menu-item"
																							aria-haspopup="true">
																							<a href="/metronic/demo2/crud/forms/editors/ckeditor-inline.html"
																								class="menu-link">
																								<i
																									class="menu-bullet menu-bullet-line">
																									<span></span>
																						...
																						<li class="menu-item"
																							aria-haspopup="true">
																							<a href="/metronic/demo2/crud/forms/editors/ckeditor-balloon.html"
																								class="menu-link">
																								<i
																									class="menu-bullet menu-bullet-line">
																									<span></span>
																						...
																						<li class="menu-item"
																							aria-haspopup="true">
																							<a href="/metronic/demo2/crud/forms/editors/ckeditor-balloon-block.html"
																								class="menu-link">
																								<i
																									class="menu-bullet menu-bullet-line">
																									<span></span>
																						...
																						<li class="menu-item"
																							aria-haspopup="true">
																							<a href="/metronic/demo2/crud/forms/editors/ckeditor-document.html"
																								class="menu-link">
																								<i
																									class="menu-bullet menu-bullet-line">
																									<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/editors/quill.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/editors/summernote.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/editors/bootstrap-markdown.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/layouts/default-forms.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/layouts/multi-column-forms.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/layouts/action-bars.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/layouts/sticky-action-bar.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/validation/states.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/validation/form-controls.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/forms/validation/form-widgets.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
															...
															<ul class="menu-subnav">
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/base/data-local.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/base/data-json.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/base/data-ajax.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/base/html-table.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/base/local-sort.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/base/translation.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/advanced/record-selection.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/advanced/row-details.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/advanced/modal.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/advanced/column-rendering.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/advanced/column-width.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/advanced/vertical.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/child/data-local.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/child/data-ajax.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/api/methods.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/ktdatatable/api/events.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
															...
															<ul class="menu-subnav">
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/basic/basic.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/basic/scrollable.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/basic/headers.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/basic/paginations.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/advanced/column-rendering.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/advanced/multiple-controls.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/advanced/column-visibility.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/advanced/row-callback.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/advanced/row-grouping.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/advanced/footer-callback.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/data-sources/html.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/data-sources/javascript.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/data-sources/ajax-client-side.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/data-sources/ajax-server-side.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/search-options/column-search.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/search-options/advanced-search.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/extensions/buttons.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/extensions/colreorder.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/extensions/keytable.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/extensions/responsive.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/extensions/rowgroup.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/extensions/rowreorder.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/extensions/scroller.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/crud/datatables/extensions/select.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-dot">
																						<span></span>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/crud/file-upload/image-input.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/crud/file-upload/dropzonejs.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/crud/file-upload/uppy.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
												...
												<ul class="menu-subnav">
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/user/list-default.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/user/list-datatable.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/user/list-columns-1.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/user/list-columns-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/user/add-user.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/user/edit-user.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
															...
															<ul class="menu-subnav">
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/profile/profile-1/overview.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/profile/profile-1/personal-information.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/profile/profile-1/account-information.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/profile/profile-1/change-password.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/profile/profile-1/email-settings.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/profile/profile-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/profile/profile-3.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/profile/profile-4.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/contacts/list-columns.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/contacts/list-datatable.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/contacts/view-contact.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/contacts/add-contact.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/contacts/edit-contact.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/chat/private.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/chat/group.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/chat/popup.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/projects/list-columns-1.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/projects/list-columns-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/projects/list-columns-3.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/projects/list-columns-4.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/projects/list-datatable.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/projects/view-project.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/projects/add-project.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/projects/edit-project.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/support-center/home-1.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/support-center/home-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/support-center/faq-1.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/support-center/faq-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/support-center/faq-3.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/support-center/feedback.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/support-center/license.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/todo/tasks.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/todo/docs.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/todo/files.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
															...
															<ul class="menu-subnav">
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/school/dashboard.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/school/statistics.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/school/calendar.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/school/library.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/school/teachers.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/school/students.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/student/dashboard.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/student/profile.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/student/calendar.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																			...
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/student/classmates.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
																...
																<li class="menu-item menu-item-submenu"
																	...
																	<div
																		...
																		<ul class="menu-subnav">
																			<li class="menu-item" aria-haspopup="true">
																				<a href="/metronic/demo2/custom/apps/education/class/dashboard.html"
																					class="menu-link">
																					<i
																						class="menu-bullet menu-bullet-line">
																						<span></span>
													...
													<li class="menu-item menu-item-open menu-item-here menu-item-submenu"
														...
														<div
															...
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/ecommerce/dashboard.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/ecommerce/dashboard-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/ecommerce/dashboard-3.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/ecommerce/dashboard-4.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/ecommerce/dashboard-5.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/ecommerce/my-orders.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item menu-item-active"
																	aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/ecommerce/order-details.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/ecommerce/shopping-cart.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/apps/ecommerce/checkout.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="/metronic/demo2/custom/apps/inbox.html"
															class="menu-link">
															<span class="svg-icon menu-icon">
																<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/General/Shield-check.svg-->
																<svg xmlns="http://www.w3.org/2000/svg"
												...
												<div class="menu-subnav">
													<ul class="menu-content">
														<li class="menu-item">
															...
															<ul class="menu-inner">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/pricing/pricing-1.html"
																		class="menu-link">
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/pricing/pricing-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/pricing/pricing-3.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/pricing/pricing-4.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
														...
														<li class="menu-item">
															...
															<ul class="menu-inner">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/wizard/wizard-1.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/wizard/wizard-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/wizard/wizard-3.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/wizard/wizard-4.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/wizard/wizard-5.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/wizard/wizard-6.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
														...
														<li class="menu-item">
															...
															<ul class="menu-inner">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/invoices/invoice-1.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/invoices/invoice-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/invoices/invoice-3.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/invoices/invoice-4.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/invoices/invoice-5.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/invoices/invoice-6.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
														...
														<li class="menu-item">
															...
															<ul class="menu-inner">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/login-1.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/login-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/login-3/signup.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/login-4/signup.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
														...
														<li class="menu-item">
															...
															<ul class="menu-inner">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/classic/login-1.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/classic/login-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/classic/login-3.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/classic/login-4.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/classic/login-5.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/login/classic/login-6.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
														...
														<li class="menu-item">
															...
															<ul class="menu-inner">
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/error/error-1.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/error/error-2.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/error/error-3.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/error/error-4.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/error/error-5.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
																...
																<li class="menu-item" aria-haspopup="true">
																	<a href="/metronic/demo2/custom/pages/error/error-6.html"
																		class="menu-link">
																		<i class="menu-bullet menu-bullet-line">
																			<span></span>
																		</i>
											...
											<div id="order_header" class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
												<div class="col-md-10">
													<div
														...
														<h1 class="display-4 font-weight-boldest mb-10">ORDER DETAILS
														</h1>
														<div class="d-flex flex-column align-items-md-end px-0">
															...
															<span
																...
																<span><?= $get_store_prp['saddress'];?></span>
													...
													<div class="d-flex justify-content-between pt-6">
														<div class="d-flex flex-column flex-root">
															...
															<span
																class="opacity-70"><?= $get_s_order['created_at'] ?></span>
														</div>
														<div class="d-flex flex-column flex-root">
															<span class="font-weight-bolder mb-2">ORDER NO.</span>
															<span
																class="opacity-70"><?= $get_s_order['order_name'] ?></span>
														</div>
														<div class="d-flex flex-column flex-root">
															<span class="font-weight-bolder mb-2">DELIVERED TO.</span>
															<span class="opacity-70"><?= $to_address?></span>
														</div>
													</div>
												</div>
											</div>
