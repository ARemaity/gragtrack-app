            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="cart-activities.php" class="text-white text-hover-white opacity-75 hover-opacity-100">
                            Cart Activities </a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
            ...
            <div class="col-xl-12">
                ...
                <div class="card card-custom gutter-b card-stretch">
                    ...
                    <div class="card-header border-0 pt-5">
                        <div class="card-title">
                          ...
                          <i class="fa fa-info-circle " data-html="true" data-toggle="tooltip" data-placement="right"
                                    title=""
                                    data-original-title="Graph number of Cart for both Checkout,Abandoned cart with Revenue w.r.t to time"
                    ...
                    <div class="card-body d-flex flex-column">
                        <div id="graph_cart_mixed" style="height: 300px;"></div>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Tiles Widget 1-->
...
<div class="card card-custom bg-gray-100 card-stretch gutter-b">
    ...
    <div class="card-body" style="position: relative;">
        <div class="tab-content">
            <div class="tab-pane fade show active" id="kt_checkout_cart"
                role="tabpanel" aria-labelledby="kt_checkout_cart">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">Checkout Cart</span>
                                ...
                                <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="pl-0 py-8">
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50 symbol-light mr-4">
                                                        <span class="symbol-label">
                                                            <img src="/metronic/theme/html/demo7/dist/../assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
                                            ...
                                            <td>
                                                <img src="/metronic/theme/html/demo7/dist/../assets/media/logos/stars.png" alt="image" style="width: 5.5rem">
                                        ...
                                        <tr>
                                            <td class="pl-0 py-0">
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50 symbol-light mr-4">
                                                        <span class="symbol-label">
                                                            <img src="/metronic/theme/html/demo7/dist/../assets/media/svg/avatars/018-girl-9.svg" class="h-75 align-self-end" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td class="pl-0 py-8">
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50 symbol-light mr-4">
                                                        <span class="symbol-label">
                                                            <img src="/metronic/theme/html/demo7/dist/../assets/media/svg/avatars/047-girl-25.svg" class="h-75 align-self-end" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td class="pl-0 py-0">
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50 symbol-light mr-4">
                                                        <span class="symbol-label">
                                                            <img src="/metronic/theme/html/demo7/dist/../assets/media/svg/avatars/014-girl-7.svg" class="h-75 align-self-end" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
                                            ...
                                            <td>
                                                <img src="/metronic/theme/html/demo7/dist/../assets/media/logos/stars.png" style="width: 5.5rem" alt="">
