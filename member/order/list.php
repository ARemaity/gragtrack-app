...
<html lang="en">
    ...
    <base href="../../">
		...
		<meta charset="utf-8" />
		<title>Order List| Gracktrack</title>
...
var path="<?php echo DIR_ROOT ?>";
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url(assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed page-loading">
														...
														<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
															...
															<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																<ul class="menu-subnav">
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="/metronic/demo2/features/icons/keenthemes-icons.html" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
														...
														<li class="menu-item menu-item-open menu-item-here menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
															...
															<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																<ul class="menu-subnav">
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="/metronic/demo2/custom/apps/ecommerce/dashboard-4.html" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="/metronic/demo2/custom/apps/ecommerce/dashboard-5.html" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
															...
															<div class="row align-items-center">
																...
																<div class="col-md-4 my-2 my-md-0">
																	<select class="form-control form-control-solid" id="kt_datatable_search_type">
																		...
																		<option value="3">Restocked</option>
																	</select>
																</div>
															</div>
														</div>
		...
		<!--end::Demo Panel-->
		<script>var HOST_URL = <?php echo DIR_ ?> ;</script>
		...
		<script src="assets/js/pages/my-script/member/order/list.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>