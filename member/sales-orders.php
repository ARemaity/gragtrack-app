            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="sales-orders.php" class="text-white text-hover-white opacity-75 hover-opacity-100">
                            Sales & Orders </a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                    ...
                    <div class="card card-custom bgi-no-repeat card-stretch gutter-b"
                        ...
                        <div class="card-body my-1">
                            ...
                            <div class="font-weight-bold text-muted font-size-lg">
                                ...
                                <span class="font-weight-bold text-muted font-size-lg"> Total Revenue</span></div>
                                ...
                                <div class="row">
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card-body my-1">
                                            ...
                                            <div class="font-weight-bold text-muted font-size-lg">
                                                <span
                                                    class="text-dark-75 font-weight-bolder font-size-h1 mr-2">90%</span>
                                            </div>
                                            ...
                                            <div class="percentage-container">
                                                ...
                                                <span class="font-weight-bold text-muted font-size-lg">Sales
                                                    Growth</span>
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card-body my-1">
                                            ...
                                            <div class="font-weight-bold text-muted font-size-sm">
                                                <span
                                                    class="text-dark-75 font-weight-bolder font-size-h1 mr-2">39%</span>
                                            </div>
                                            <div class="progress progress-xs mt-7 bg-info-o-60"
                                                style="margin-bottom: 10px;">
                                            ...
                                            <div class="percentage-container">
                                                ...
                                                <span class="font-weight-bold text-muted font-size-lg">Product
                                                    Growth</span>
                                            </div>
                                        </div>
                                        <!--end::Stats Widget 23-->
                                    ...
                                    <div class="col-xl-4">
                                        <div class="card-body my-1">
                                            ...
                                            <div class="font-weight-bold text-muted font-size-sm">
                                                <span
                                                    class="text-dark-75 font-weight-bolder font-size-h1 mr-2">54%</span>
                                            </div>
                                            <div class="progress progress-xs mt-7 bg-info-o-60"
                                                style="margin-bottom: 10px;">
                                                <div class="progress-bar bg-dark bg-hover-state-dark" role="progressbar"
                                                    style="width: 54%;" aria-valuenow="50" aria-valuemin="0"
                                                    aria-valuemax="100"></div>
                                            </div>
                                            <div class="percentage-container">

                                                <span class="font-weight-bold text-muted font-size-lg">Clients
                                                    Growth</span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            <div id="map_location" style="height: 500px; overflow: visible; text-align: left;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body">
                                    ...
                                    <div id="chart_shopify_mixed" class="rounded-xl" style="min-height: 300px;">
